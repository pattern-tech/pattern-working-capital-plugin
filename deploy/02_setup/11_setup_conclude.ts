...
import {WorkingCapital__factory, WorkingCapitalSetup__factory} from '../../typechain';
...
const func: DeployFunction = async function (hre: HardhatRuntimeEnvironment) {
  ...
  const setup = WorkingCapitalSetup__factory.connect(
    setupDeployment.address,
    deployer
  );
  const implementation = WorkingCapital__factory.connect(
